...
- **Прямой редирект**: При включении и типе оплаты QR мобильные пользователи автоматически перенаправляются в банковское приложение при открытии страницы оплаты, без необходимости нажимать кнопку вручную. Страница продолжает отслеживать статус платежа в фоне и перенаправляет на URL успеха/ошибки по завершении.
